...
* Pasta > Tabelas: estão todas as tabelas utilizadas, baixadas diretamente do kaggle.
* Arquivos:
    ...
    * Apresentação detalhada Projeto 1 Olist.pdf: a transcrição da apresentação, com slides, explicações e conclusões sobre o banco de dados. 
